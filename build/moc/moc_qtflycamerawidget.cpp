...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tucano__QtFlycameraWidget_t, stringdata) + ofs \
...
const QMetaObject Tucano::QtFlycameraWidget::staticMetaObject = {
    { &QtGlewFlycameraInitializer::staticMetaObject, qt_meta_stringdata_Tucano__QtFlycameraWidget.data,
      qt_meta_data_Tucano__QtFlycameraWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tucano__QtFlycameraWidget.stringdata))
