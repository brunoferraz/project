...
HEADERS  += mainwindow.h \        
        ...
        $$TUCANO_PATH/effects/depthMap.hpp \
        $$TUCANO_PATH/effects/ssrt.hpp \
        $$TUCANO_PATH/src/utils/qttrackballwidget.hpp

FORMS    += mainwindow.ui

OTHER_FILES += \
        $$TUCANO_PATH/effects/shaders/ssrt.frag \
        $$TUCANO_PATH/effects/shaders/ssrt.vert \
        $$TUCANO_PATH/effects/shaders/showFbo.frag \
        $$TUCANO_PATH/effects/shaders/showFbo.vert \
        $$TUCANO_PATH/effects/shaders/depthMap.frag \
        $$TUCANO_PATH/effects/shaders/depthMap.vert \
